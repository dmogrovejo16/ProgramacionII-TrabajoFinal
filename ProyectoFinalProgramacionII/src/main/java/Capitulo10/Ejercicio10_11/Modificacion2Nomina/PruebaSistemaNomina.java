...
public class PruebaSistemaNomina {
	...
	EmpleadoAsalariado empleadoAsalariado =
	 new EmpleadoAsalariado( "John", "Smith", "111-11-1111", 800.00 ,13,01,2000);
	 EmpleadoPorHoras empleadoPorHoras =
	 new EmpleadoPorHoras( "Karen", "Price", "222-22-2222", 16.75, 40,13,01,2000 );
	 EmpleadoPorComision empleadoPorComision =
	 new EmpleadoPorComision(
	 "Sue", "Jones", "333-33-3333", 10000, .06 ,13,01,2000);
	 EmpleadoBaseMasComision empleadoBaseMasComision =
	 new EmpleadoBaseMasComision(
	 "Bob", "Lewis", "444-44-4444", 5000, .04, 300 ,13,01,2000);
	 
	 EmpleadoPorPieza empleadoPorPiezas = new EmpleadoPorPieza( "Mario", "Smith", "111-11-1111", 80.00,5 ,13,01,2000);
	 ...
	 System.out.printf( " nuevo salario base con 10%% de aumento es : $%,.2f\n", empleado.obtenerSalarioBase() );
	 } // fin de if
